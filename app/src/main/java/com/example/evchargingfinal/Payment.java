...
public class Payment {
    String payment_id, payment_from_user_id, payment_from_name, payment_to_owner_id, payment_to_name;
    int payment_amount, payment_energy_sold;

    public Payment() {
    }

    public Payment(String payment_id, String payment_from_user_id, String payment_from_name, String payment_to_owner_id, String payment_to_name, int payment_amount, int payment_energy_sold) {
